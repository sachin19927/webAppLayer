...
function ListComponent_mat_header_row_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("defaultColor", "yellow")("highLight", "red");
  }
}
...
ListComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
  ...
  decls: 13,
  vars: 13,
  consts: [["appHighlightDirective", ""], ["type", "text", 3, "ngModel", "ngModelChange"], [3, "click"], [3, "dataSource"], [3, "matColumnDef", 4, "ngFor", "ngForOf"], ["appHighlightBetter", "", 3, "defaultColor", "highLight", 4, "matHeaderRowDef"], [4, "matRowDef", "matRowDefColumns"], [3, "matColumnDef"], [4, "matHeaderCellDef"], [4, "ngIf"], [4, "matCellDef"], ["mat-icon-button", "", "aria-label", "Example icon-button with a menu", 3, "matMenuTriggerFor"], ["menu", "matMenu"], ["mat-menu-item", "", 3, "click"], ["appHighlightBetter", "", 3, "defaultColor", "highLight"]],
  template: function ListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](11, ListComponent_mat_header_row_11_Template, 1, 2, "mat-header-row", 5);
