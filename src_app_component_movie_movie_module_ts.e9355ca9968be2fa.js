...
ListComponent.ɵfac = function ListComponent_Factory(t) { return new (t || ListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_service_movie_service_service__WEBPACK_IMPORTED_MODULE_0__.MovieServiceService)); };
ListComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ListComponent, selectors: [["app-list"]], decls: 1, vars: 1, consts: [[4, "ngFor", "ngForOf"]], template: function ListComponent_Template(rf, ctx) { if (rf & 1) {
...
MovieManagementComponent.ɵfac = function MovieManagementComponent_Factory(t) { return new (t || MovieManagementComponent)(); };
MovieManagementComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MovieManagementComponent, selectors: [["app-movie", 8, "management"]], attrs: _c0, decls: 1, vars: 0, template: function MovieManagementComponent_Template(rf, ctx) { if (rf & 1) {
...
MovieModule.ɵmod = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineNgModule"]({ type: MovieModule });
MovieModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineInjector"]({ imports: [_angular_common__WEBPACK_IMPORTED_MODULE_7__.CommonModule,
        _angular_router__WEBPACK_IMPORTED_MODULE_8__.RouterModule.forChild(_movie_routing__WEBPACK_IMPORTED_MODULE_5__.movieRoutes)] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵsetNgModuleScope"](MovieModule, { declarations: [_add_add_component__WEBPACK_IMPORTED_MODULE_0__.AddComponent,
        ...
        _movie_management_movie_management_component__WEBPACK_IMPORTED_MODULE_4__.MovieManagementComponent], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_7__.CommonModule, _angular_router__WEBPACK_IMPORTED_MODULE_8__.RouterModule] }); })();
...
const movieRoutes = [
    {
        path: '', component: _movie_management_movie_management_component__WEBPACK_IMPORTED_MODULE_3__.MovieManagementComponent,
        children: [
...
MovieServiceService.ɵfac = /*@__PURE__*/ function () { let ɵMovieServiceService_BaseFactory; return function MovieServiceService_Factory(t) { return (ɵMovieServiceService_BaseFactory || (ɵMovieServiceService_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetInheritedFactory"](MovieServiceService)))(t || MovieServiceService); }; }();
MovieServiceService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: MovieServiceService, factory: MovieServiceService.ɵfac, providedIn: 'root' });
