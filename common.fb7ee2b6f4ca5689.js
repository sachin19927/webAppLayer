...
class HttpClientService {
  ...
  create(url, data) {
    return this.httpClient.post(url, JSON.stringify(data), this.httpOptions).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.errorHandler));
  }
  getById(url, params) {
    return this.httpClient.get(url + '/' + params, this.httpOptions).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.errorHandler));
  }
  getAll(url, params) {
    return this.httpClient.get(url, this.httpOptions).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.errorHandler));
  }
  update(url, params, data) {
    return this.httpClient.put(url, JSON.stringify(data), this.httpOptions).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.errorHandler));
  }
  delete(url, params) {
    return this.httpClient.delete(url, this.httpOptions).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.errorHandler));
  }
  errorHandler(error) {
    let errorMessage = '';
...
HttpClientService.ɵfac = function HttpClientService_Factory(t) {
  return new (t || HttpClientService)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_src_app_service_api_logger_service__WEBPACK_IMPORTED_MODULE_0__.ApiLoggerService));
};
HttpClientService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
